        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black bg-opacity-50">
          ...
          >
            ...
            <div className="space-y-4">
              <p>
                Word Mastermind is a multiplayer word-guessing game where you
                try to guess your opponent's secret 4-letter word.
              </p>
              ...
              <div>
                ...
                <p className="text-sm">
                  You can click the "Prove" button next to your opponent's
                  guesses to reveal the feedback they received. This helps
                  verify that the game is fair and that your opponent is
              ...
              <div>
                ...
                <ul className="list-disc pl-5 space-y-1">
                  ...
                  <li>
                    Remember that all letters in the secret word are unique
                  </li>
                </ul>
              </div>
            </div>
